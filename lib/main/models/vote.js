var Vote = function(){
  ...
  var _setup = function _setup(callback) {
    _db.query('CREATE TABLE votes (bet_id integer NOT NULL, ip character(15) NOT NULL, vote boolean NOT NULL, CONSTRAINT "votes_key" PRIMARY KEY (bet_id, ip, vote) )', function(err, result) {
    });
  }
